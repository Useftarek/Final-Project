  ...
  return (
    <div className="products_colors">
      ...
      <div className="colors_div">
        <div
          className={`color clr1 ${activeColor === "clr1" ? "active" : ""}`}
          onClick={() => handleColorClick("clr1")}
        >
          {activeColor === "clr1" && <span className="check-mark">✔</span>}
        </div>
        <div
          className={`color clr2 ${activeColor === "clr2" ? "active" : ""}`}
          onClick={() => handleColorClick("clr2")}
        >
          {activeColor === "clr2" && <span className="check-mark">✔</span>}
        </div>

        <div
          className={`color clr3 ${activeColor === "clr3" ? "active" : ""}`}
          onClick={() => handleColorClick("clr3")}
        >
